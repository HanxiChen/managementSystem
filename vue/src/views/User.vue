<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload :action="'https://' + serverIp + ':9090/user/import'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
export default {
  ...
  methods: {
    ...
    save() {
      this.request.post("/user", this.form).then(res => {   //弹窗中的确定按钮
        if (res.code === '200') {
